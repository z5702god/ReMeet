...
struct MeetingContextInputView: View {
    ...
    @ObservedObject var contactViewModel: AddContactViewModel
    let imageUrl: String?
    let onSave: () -> Void

    @Environment(\.dismiss) private var dismiss
    @StateObject private var viewModel = MeetingContextViewModel()
    ...
    private func saveContact() async throws -> Contact {
        ...
        return try await supabase.createContact(contact)
    }
}
