...
struct BatchEditView: View {
    ...
    private var completionView: some View {
        VStack(spacing: AppSpacing.lg) {
            ...
            .accessibleButton(label: "Finish and return to camera")
    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                .accessibleButton(label: "Save contact and continue to next card")
                ...
                .accessibleButton(label: "Skip this card without saving")
            }
        }
